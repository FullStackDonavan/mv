    ...
    <div class="container mx-auto px-4 max-w-7xl">
      <ContentList path="/articles" v-slot="{ list }">
        <div class="flex flex-col items-center">
          <h1 class="text-4xl md:text-5xl font-bold text-center mb-4 text-gray-900 dark:text-white">Insurance & Financial Planning Articles</h1>
          <p class="text-lg text-gray-600 dark:text-gray-300 text-center mb-12 max-w-3xl">
            Discover expert insights and guidance on insurance, financial planning, and protecting what matters most.
          </p>
